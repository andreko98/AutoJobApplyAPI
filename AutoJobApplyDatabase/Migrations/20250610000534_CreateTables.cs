    ...
    public partial class CreateTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            columns: table => new
            {
                ...
                EmailCredentialId = table.Column<int>(type: "int", nullable: true)
            },
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    name: "FK_Users_EmailCredentials_EmailCredentialId",
                    column: x => x.EmailCredentialId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MessageSent = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
